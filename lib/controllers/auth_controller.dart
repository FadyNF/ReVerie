...
class AuthController {
  ...
  Future<Profile> signUpWithEmail({
    ...
    if (user == null) {
      ...
      throw Exception(
        'Signup succeeded but no user returned. Check Supabase Auth email confirmation settings.',
      );
    }
...
//     await _ensureRoleProfileExists(profile);
...
//   Future<void> _ensureRoleProfileExists(Profile profile) async {
//     if (profile.role == 'consumer') {
//       await _sb.from('consumer_profiles').upsert({
//         'user_id': profile.id,
//       });
//       return;
//     }
...
//       await _sb.from('doctor_profiles').upsert({
//         'user_id': profile.id,
//       });
//     }
//   }
