...
class _WaitingApprovalScreenState extends State<WaitingApprovalScreen> {
  ...
  bool get _requestSentDone => true;

  bool get _doctorReviewDone => widget.status == 'approved';

  bool get _confirmationDone => widget.status == 'approved';
  ...
  String get _statusSubtitle {
    switch (widget.status) {
      case 'approved':
        return "Your request has been approved by the doctor.";
      case 'rejected':
        return "Your request was not approved. You can choose another doctor.";
      case 'pending':
      default:
        return "Your appointment request has been sent to\nthe doctor. You'll receive a notification\nonce it's approved.";
    }
  }
  ...
  Future<void> _cancelRequest() async {
    ...
    try {
      await _admissionProvider.cancelRequest(widget.requestId);

      if (!mounted) return;

      Navigator.pop(context); // close dialog if open
      Navigator.pop(context); // go back from waiting screen
              ...
              child: OutlinedButton(
                onPressed: () {
                  ...
                  Navigator.pushReplacement(
                    context,
                    MaterialPageRoute(
                      builder: (_) => const RecommendedDoctorsScreen(),
                    ),
                  );
                },
  ...
  Widget build(BuildContext context) {
    final doctorProfile = DoctorProfileModel.fromRecommendedDoctor(
      widget.doctor,
    );
                  ...
                  children: [
                    ...
                    _StepRow(
                      ...
                      subtitle: widget.status == 'approved'
                          ? 'The doctor has reviewed and approved your request'
                    ...
                    _StepRow(
                      ...
                      subtitle: widget.status == 'approved'
                          ...
                          : "You'll get notified of the approval",
                    ),
                  ],
                ),
              ),
                    ...
                    child: ElevatedButton(
                      onPressed: () {
                        Navigator.push(
                          ...
                          MaterialPageRoute(
                            builder: (_) =>
                                DoctorProfileScreen(doctor: doctorProfile),
                          ),
                        );
                      },
                      style: ElevatedButton.styleFrom(
